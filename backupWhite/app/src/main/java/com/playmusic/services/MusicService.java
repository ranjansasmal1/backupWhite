...
import com.playmusic.helpers.SongHelper;
...
public class MusicService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    SongHelper mMediaPlayerSongHelper;
...
//        }
    ...
    private Notification buildNotification(SongHelper songHelper) {
            return BuildNotification(songHelper);
    }
    ...
    public void updateNotification(SongHelper songHelper) {
        Notification notification = null;
            notification = BuildNotification(songHelper);
    ...
    public Notification BuildNotification(SongHelper songHelper){
